  ...
  <div class="other-message-body">
    ...
    <div class="message-content">
      ...
      >
        ...
        <p v-if="message.type == 'text'" ref="message-content">
          {{ message.content }}
        </p>
        <img
          v-if="message.type == 'image' && message.uploaded == true"
          :src="message.src"
          alt=""
          @click="onImageClicked(message)"
        />
        <div
          v-if="message.type == 'image' && message.uploaded == false"
          class="message-image"
        >
          <img
      ...
      <div
        ...
        :style="{ 'justify-content': 'baseline', color: 'black' }"
      >
